...
function Profile({ formData, handleChange, checkboxHandler, gender, setGender, handleKeyDown }) {
	return (
			...
			<div className="w-full">
				<div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
					...
					<div className="sm:col-span-4">
						<label htmlFor="former_name" className="block text-sm font-medium leading-6 text-gray-900">
							Former name (if any)
						</label>
						<div className="mt-2">
							<input
								...
								className="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-transparent"
								onChange={handleChange}
