                ...
                <div className='w-full'>
                    <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            <label for="street_address" className="block text-sm font-medium leading-6 text-gray-900">
                                Residence Address
                            </label>
                        ...
                        <div className="sm:col-span-2">
                            <label for="county" className="block text-sm font-medium leading-6 text-gray-900">
                                County
                            </label>
                            <div className='mt-2'>
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        ...
                        <div className="sm:col-span-1">
                            <label for="zip_code" className="block text-sm font-medium leading-6 text-gray-900">Zip code</label>
                            <div className="mt-2">
                        ...
                        <div className="mt-6 space-y-6">
                            <div className="relative flex gap-x-3">
                                ...
                                <div className="text-sm leading-6">
                                    <label for="mailing" className="font-medium text-gray-900 cursor-pointer">
                    ...
                    <div className="sm:col-span-1 mt-10">
                        <label for="former_res" className="block text-sm font-medium leading-6 text-gray-900">City and County of Former Residence in Texas</label>
                        <div className="mt-2">
